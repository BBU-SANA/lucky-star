            ...
            <div id="sidebar-menu">
                <ul>
                    ...
                    <li class="has_sub">
                        ...
                        <ul class="list-unstyled">
                            <li><a href="index-2.html">Users List</a></li>
                            <li><a href="dashboard_2.html">Add Users</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="has_sub">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a href="dashboard_2.html">Brands List</a></li>
                    ...
                    <li class="has_sub">
                        ...
                        <ul class="list-unstyled">
                            <li><a href="index-2.html">Products List</a></li>
                            <li><a href="dashboard_2.html">Add Products</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="has_sub">
                        ...
                        <ul class="list-unstyled">
                            <li><a href="index-2.html">Selling List</a></li>
                            <li><a href="dashboard_2.html">Add Selling</a></li>
                        </ul>
                    </li>

                    <li class="has_sub">
                        <a href="javascript:void(0);" class="waves-effect"><i class=" ti-check-box"></i> <span> Sell History </span></a>
                    </li>
